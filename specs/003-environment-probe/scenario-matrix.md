...
- the last-open-branch/campaign-completion/total-time race: completion committed
  ...
  the Route-bearing zero-open `campaign_bound_stop` arm, consumes the bound
