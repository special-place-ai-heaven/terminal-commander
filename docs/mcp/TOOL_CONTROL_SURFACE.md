...
The current rmcp stdio adapter exposes 29 live tools.

| Group | Tools |
|---|---|
| Discovery and health | `system_discover`, `health`, `policy_status`, `self_check` |
| Commands and buckets | `command_start_combed`, `command_status`, `bucket_events_since`, `bucket_wait`, `bucket_summary`, `event_context` |
