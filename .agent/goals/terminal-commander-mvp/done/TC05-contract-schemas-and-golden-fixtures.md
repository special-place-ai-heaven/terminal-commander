...
- Event/rule contract MUST reserve all 11 sifter type discriminators from README.md:136-148 (keyword, regex, prompt, exit_code, stream_marker, progress_collapse, dedupe, threshold, sequence, anchor, custom) as canonical enum values; fixtures may stub unimplemented variants.
