...
- Handle file created after probe start, truncation, and inode/path replacement where practical for Linux/WSL.
...
git diff --check
cargo fmt --check
cargo test -p terminal-commander-probes file_probe
```
