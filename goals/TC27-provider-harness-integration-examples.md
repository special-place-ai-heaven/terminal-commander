...
- Create generic MCP config examples for stdio or local server mode as supported by TC23.
- Create Claude Code and Codex CLI notes only to the extent supported by available evidence or clearly label as template/unverified.
